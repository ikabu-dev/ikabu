...
import { getBankaraDummyProperties } from '@/infra/external/splatoon3-ink/types/bankara_properties';
import { getEventDummyProperties } from '@/infra/external/splatoon3-ink/types/event_properties';
import { getFestDummyProperties } from '@/infra/external/splatoon3-ink/types/fest_properties';
import { Sp3Locale } from '@/infra/external/splatoon3-ink/types/locale';
import { getRegularDummyProperties } from '@/infra/external/splatoon3-ink/types/regular_properties';
import { getSalmonRegularDummyProperties } from '@/infra/external/splatoon3-ink/types/salmon_properties';
import { Sp3Schedule } from '@/infra/external/splatoon3-ink/types/schedule';
import { getXDummyProperties } from '@/infra/external/splatoon3-ink/types/x_properties';
